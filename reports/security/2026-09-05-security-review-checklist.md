...
| SEC-ACADEMY-009 | Credential storage | digest session id ก่อนทุก RPC; migration0034 hash แถวเดิมใน place และจัดการ in-flight ด้วย retry | LOCAL CODE VERIFIED — MIGRATION REVIEW/PRODUCTION OPEN | 2026-09-07 | Focused RED exit1 then GREEN `87/87`; independent migration/rollback review, owned local DB proof, full baseline3/buildCF, production apply remain |
