...
- **Sources:** Fable (#1/#15/#23) · **Status:** LOCAL GATES + INDEPENDENT REVIEW VERIFIED — PENDING PRODUCTION
...
| SEC-ACADEMY-010 | Bearer binding | ผูก grant กับ session digest; Worker เทียบ exact one `academy_session` ก่อน R2 | LOCAL GATES + INDEPENDENT REVIEW VERIFIED — PENDING PRODUCTION | 2026-09-07 | production deploy, immediate revocation lag, delivery-log accountability |
