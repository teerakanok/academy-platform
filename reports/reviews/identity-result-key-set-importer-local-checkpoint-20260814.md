...
importer test b9f99cffaf024680f2fe3e0cd5db2a087544555c0fdc4d8b95b42a7e4253def0
cache test    f55fda97056a00258057cfa4782d7a26989b2e33ed68142713ba35902ea6adf5
```

**แก้ตัวเลขที่จดผิด (2026-08-15):** บรรทัด `importer test` เคยเขียนไว้เป็น
`1181b90e0be624f9c808f24078af5b831e52d7519d27ffbe0234d29f7406daa1` ซึ่งไม่เคยเป็น
ค่าจริงของไฟล์นี้ รีวิวข้าม repo จับได้ · ตรวจย้อนแล้วไฟล์ไม่ได้เปลี่ยนเลยตั้งแต่
commit `f5244bd` (`git show f5244bd:…` ให้ค่าเดียวกับไฟล์ปัจจุบัน) จึงเป็นการ
**จดผิด ไม่ใช่ drift** อีกสามบรรทัดตรงกับไฟล์จริงทั้งหมด
