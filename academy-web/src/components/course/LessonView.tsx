...
// ซึ่งขัดกับหลักของ product เองที่ว่า "การบอกเองไม่เคยนับ" — สิ่งที่ทำให้บทขยับ
// สถานะคือ checkpoint และหลักฐานที่ใบรับรองอ้างถึงคือ **ด่านบังคับเท่านั้น** (W0-3)
// คนที่ติ๊กครบเร็วที่สุดมักเป็นคนที่รู้น้อยที่สุด
