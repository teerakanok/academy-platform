...
//
// ผลที่ตามมาซึ่งสำคัญ: **การ test out นับเท่ากับการอ่านจบทุกประการ** ใครที่รู้อยู่
// แล้วและพิสูจน์ได้ ต้องได้ใบเท่ากับคนที่อ่านทีละบท ไม่มีเหตุผลใดที่จะลงโทษคนที่
// รู้มาก่อน
//
// สิ่งเดียวที่ยังไม่นับคือ "ข้ามโดยรับสรุปไป" (skipped) เพราะมันไม่ได้ทิ้งหลักฐาน
// อะไรไว้เลย — ไม่ใช่การลงโทษ และไม่ใช่ประตูที่ปิดตาย: กด test out บทนั้นเมื่อไหร่
// ก็ได้ ใบออกทันที
//
