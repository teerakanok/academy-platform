...
alter function academy.run_retention_course_entitlement_history() owner to academy_retention_definer;
...
grant execute on function academy.run_retention_course_entitlement_history() to academy_retention;
