...
> ⚠️ **ข้อที่ตามมาจากจุดยืนนี้:** ถ้าคูเมืองคือ lab แปลว่า **M4 (lab plane) สำคัญกว่า
> งานกัน crawler ทุกข้อ** — ตอนนี้ lab ยังเป็นกล่องเปล่าและ simulation มี surface เดียว
> อย่าลงแรงกับการกัน crawler มากกว่าการสร้างสิ่งที่ทำให้ข้อความที่หลุดไปไม่มีค่า
