...
**สิ่งที่ยังเหลือใน W0-0:** `/api/attempts` คืน MCQ ที่ remap key แล้ว **แต่ยังไม่มีใครใช้** —
UI เรนเดอร์ MCQ จากไฟล์ (key จริง) และ `/api/progress` ตรวจด้วย key จริง แปลว่าคำตอบ
capstone คงที่ตลอดและแชร์กันได้ ซึ่งเป็นสิ่งที่ W0-0 ตั้งใจกัน → งานถัดไปคือต่อสายนี้
